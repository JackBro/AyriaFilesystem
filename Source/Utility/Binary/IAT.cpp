...
size_t PE_Findfunction(std::string Module, std::string Function)
{
    ...
    {
        DebugPrint(COAL::va("%s: The current application does not have an import table.", __func__));
        return 0;
    }
...
size_t COAL::IAT::Findfunction(std::string Module, std::string Function)
{
#ifdef _WIN32
...
size_t COAL::IAT::Findordinal(std::string Module, uint32_t Ordinal)
{
#ifdef _WIN32
